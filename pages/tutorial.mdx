...
<Button
  ...
  link="https://misc.framerstatic.com/legacy/docs/tutorial-start.framerx"
/>
...
export function App() {
  return (
    ...
    >
      <Frame
        center
        image={"https://misc.framerstatic.com/legacy/docs/logo.jpg"}
        radius={4}
      />
    </Frame>
  )
...
>
  <Frame
    ...
    center
    size={480}
    image={"https://misc.framerstatic.com/legacy/docs/bg.jpg"}
  />
  <Slider />
</Frame>
```
...
<Button
  ...
  link="https://misc.framerstatic.com/legacy/docs/tutorial-complete.framerx"
/>
</div>
<div>
...
- [**Framer:** Drag Properties & Events](/legacy/docs/frame/#drag)
- [**Framer:** MotionValue](</legacy/docs/animation/#(motionvalue:class)>)
- [**Framer:** useMotionValue()](/legacy/docs/animation/#usemotionvalue)
- [**Framer:** useTransform()](/legacy/docs/animation/#usetransform)
...
If you’d like to see some more examples on animation, gestures, dragging, paging, scrolling and more [visit our examples](/legacy/docs/examples/) section for detailed explanations and code samples.
